...
using ESport.Model;
using ESport.Services.EFServices;
...
namespace ESport
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ESportContext>();
            ...
            services.AddTransient<IProfileService, EFProfileService>();
            services.AddTransient<IScoreService, EFScoreService>();
